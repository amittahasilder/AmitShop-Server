...
//         for (
//           const completedUpdate of completedStockUpdates
//         ) {
//           await Product.findByIdAndUpdate(
//             completedUpdate.productId,
//             {
...
//     // ==========================================
//     // SELLER HAS NO PRODUCT IN THIS ORDER
//     // ==========================================
...
//       success: false,
//       message:
//         "Something went wrong while fetching seller order",
//     });
//   }
// };
...
export const updateSellerOrderStatus = async (
  ...
  try {
    ...
    if (req.user.role !== "admin") {
      ...
      // ========================================
      // SELLER HAS NO PRODUCT IN ORDER
      // ========================================
    ...
    try {
      ...
      console.error(
        "Seller Order Status Email Error:",
        emailError.message
      );
    }
    ...
    return res.status(500).json({
      success: false,
      message:
        "Something went wrong while updating seller order status",
    });
  }
};